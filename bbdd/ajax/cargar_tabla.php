<?php
	...
	foreach($datos as $row){
		...
		$tablaDetalle .= "<tr><td>{$row['id']}</td><td>{$row['codigo']}</td><td>{$row['nombre']}</td><td>{$row['apellido']}</td><td><button id='btn_editar'>Editar</button><button id='btn_eliminar'>Eliminar</button></td><tr>";
	}
